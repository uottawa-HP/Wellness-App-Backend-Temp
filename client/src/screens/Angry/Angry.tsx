...
const mapStateToProps = (state: AngryProps) => ({
    auth: state.auth,
});

const Angry: React.FC<AngryProps> = (props: AngryProps) => {
    ...
    <SafeAreaView style={theme === 'light' ? styles.container : darkModeStyles.container}>
      ...
      <View style={theme === 'light' ? styles.titleContainer : darkModeStyles.titleContainer}>
        <Text style={styles.titlePage}>{dictionnary.angry.Angry}</Text>
      ...
      <View style={theme === 'light' ? styles.questionContainer : darkModeStyles.questionContainer}>
        <Text style={styles.title}>{dictionnary.angry.AngryPrompt}</Text>
      </View>
      
      <ScrollView contentContainerStyle={styles.scrollContainer}> 
        <TextInput
          style={theme === 'light' ? styles.input : darkModeStyles.input}
          placeholder={dictionnary.angry.StartWriting}
          multiline
        ...
        <View style={styles.bottomContainer}>
          ...
          <View style = {styles.buttonContainer}>
            ...
            <TouchableOpacity style={theme === 'light' ? styles.button : darkModeStyles.button} onPress={() => handlePress()} >
              <Text style={styles.save}>{dictionnary.angry.Save}</Text>
            </TouchableOpacity>
          </View>
        </View>
      </KeyboardAvoidingView>
...
export default connect(mapStateToProps)(Angry);