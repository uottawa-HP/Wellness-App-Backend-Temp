...
const mapStateToProps = (state: LonelyProps) => ({
    auth: state.auth,
});

const Lonely: React.FC<LonelyProps> = (props: LonelyProps) => {
    ...
    return (
      ...
      <View style={theme === 'light' ? styles.titleContainer : darkModeStyles.titleContainer}>
        <Text style={styles.titlePage}>{dictionnary.lonely.Lonely}</Text>
      ...
      <View style={theme === 'light' ? styles.questionContainer : darkModeStyles.questionContainer}>
        <Text style={styles.title}>{dictionnary.lonely.LonelyPrompt}</Text>
      </View>
      
      <ScrollView contentContainerStyle={styles.scrollContainer}> 
        <TextInput
          style={theme === 'light' ? styles.input : darkModeStyles.input}
          placeholder={dictionnary.lonely.StartWriting}
          multiline
        ...
        <View style={styles.bottomContainer}>
          ...
          <View style = {styles.buttonContainer}>
            ...
            <TouchableOpacity style={theme === 'light' ? styles.button : darkModeStyles.button} onPress={() => handlePress()} >
              <Text style={styles.save}>{dictionnary.lonely.Save}</Text>
            </TouchableOpacity>
          </View>
        </View>
      </KeyboardAvoidingView>
...
export default connect(mapStateToProps)(Lonely);