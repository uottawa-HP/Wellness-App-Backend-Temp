...
interface InsecureProps {
    auth: any;
}

const mapStateToProps = (state: InsecureProps) => ({
    auth: state.auth,
});

const Insecure: React.FC<InsecureProps> = (props: InsecureProps) => {
    ...
    return (
      ...
      <View style={theme === 'light' ? styles.titleContainer : darkModeStyles.titleContainer}>
        <Text style={styles.titlePage}>{dictionnary.insecure.Insecure}</Text>
      ...
      <View style={theme === 'light' ? styles.questionContainer : darkModeStyles.questionContainer}>
        <Text style={styles.title}>{dictionnary.insecure.InsecurePrompt}</Text>
      </View>
      
      <ScrollView contentContainerStyle={styles.scrollContainer}> 
        <TextInput
          style={theme === 'light' ? styles.input : darkModeStyles.input}
          placeholder={dictionnary.insecure.StartWriting}
          multiline
        ...
        <View style={styles.bottomContainer}>
          ...
          <View style = {styles.buttonContainer}>
            ...
            <TouchableOpacity style={theme === 'light' ? styles.button : darkModeStyles.button} onPress={() => handlePress()} >
              <Text style={styles.save}>{dictionnary.insecure.Save}</Text>
            </TouchableOpacity>
          </View>
        </View>
      </KeyboardAvoidingView>
...
export default connect(mapStateToProps)(Insecure);